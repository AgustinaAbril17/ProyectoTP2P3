...
public class VentanaPrincipal {
	...
	//esto va a borrarse cuando se agregue recursos.prueba con las coordenadas de los lugares
	private void detectarCoordenadas() 
	{
		...
		mapa.addMouseListener(new MouseAdapter() 
		{
			...
			if (e.getButton() == MouseEvent.BUTTON1)
			{
				...
				String nombre = JOptionPane.showInputDialog("Nombre: ");   ///////////		VENTANA 
